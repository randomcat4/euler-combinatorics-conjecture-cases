...
EXPECTED_VERIFICATION = {
    ...
    "minimum-degree-two-degree-multiplicity": "INDEPENDENTLY_VERIFIED",
    ...
    "entropy-bounded-sidon-concentration-stability": "INDEPENDENTLY_VERIFIED",
